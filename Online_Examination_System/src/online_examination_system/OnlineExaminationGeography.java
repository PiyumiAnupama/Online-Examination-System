 ...
 * @author Padmasiri
 */
public class OnlineExaminationGeography extends javax.swing.JFrame {

   
    
    public OnlineExaminationGeography() {
        initComponents();
        Connect();
        Examination();
        ...
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
             con=DriverManager.getConnection("jdbc:mysql://localhost/final_project","root","");
                ...
                Logger.getLogger(OnlineExaminationGeography.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void submit(){
        ...
        try{
            Statement st=con.createStatement();
            st.executeUpdate("UPDATE marksheet SET geography='"+marks+"' WHERE mid =(SELECT max(mid)FROM marksheet)");
            String marks1=String.valueOf(marks);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Geography Quiz Test ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnlineExaminationGeography.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OnlineExaminationGeography().setVisible(true);
            }
        });
    }
