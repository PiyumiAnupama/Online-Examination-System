 ...
 * @author Padmasiri
 */
public class OnlineExaminationBuddhism extends javax.swing.JFrame {

   
    
    public OnlineExaminationBuddhism() {
        initComponents();
        Connect();
        Examination();
    ...
    public void Examination(){
        ...
        try{
            ...
            ResultSet rs1=st.executeQuery("SELECT * FROM buddhism WHERE qid='"+questionID+"'");
        ...
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
             con=DriverManager.getConnection("jdbc:mysql://localhost/final_project","root","");
                ...
                Logger.getLogger(OnlineExaminationBuddhism.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void submit(){
        ...
        try{
            Statement st=con.createStatement();
            st.executeUpdate("UPDATE marksheet SET buddhism='"+marks+"' WHERE mid =(SELECT max(mid)FROM marksheet)");
            String marks1=String.valueOf(marks);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Buddhism Quiz Test ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnlineExaminationBuddhism.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OnlineExaminationBuddhism().setVisible(true);
            }
        });
    }
