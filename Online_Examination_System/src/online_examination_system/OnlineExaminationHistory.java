 ...
 * @author Padmasiri
 */
public class OnlineExaminationHistory extends javax.swing.JFrame {

   
    
    public OnlineExaminationHistory() {
        initComponents();
        Connect();
        Examination();
    ...
    public void Examination(){
        ...
        try{
            ...
            ResultSet rs1=st.executeQuery("SELECT * FROM history WHERE qid='"+questionID+"'");
        ...
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
             con=DriverManager.getConnection("jdbc:mysql://localhost/final_project","root","");
                ...
                Logger.getLogger(OnlineExaminationHistory.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void submit(){
        ...
        try{
            Statement st=con.createStatement();
            st.executeUpdate("UPDATE marksheet SET history='"+marks+"' WHERE mid =(SELECT max(mid)FROM marksheet)");
            String marks1=String.valueOf(marks);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("History Quiz Test ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnlineExaminationHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OnlineExaminationHistory().setVisible(true);
            }
        });
    }
